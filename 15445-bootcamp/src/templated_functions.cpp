...
// This cannot exist without the original template blueprint.
...
/* The value of T must be known at compile time. 
 * Since here T is not a type its a value

 * bool myVar = true; add3<myVar>(10);  <-- ERROR! The compiler says: "I don't know 
                                                   what myVar is yet!"
 * const bool myConst = true;
   add3<myConst>(10);   // WORKS! The compiler knows it's true.

 * add3<true>(10);      // WORKS! Hardcoded values are known at compile time.
*/
